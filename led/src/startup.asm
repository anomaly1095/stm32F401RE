...
__copy_data:
  ...
  STRNE r3, [r1], #0x04 @ store the word in flash
  BNE   __copy_data
...
__zero_bss:
  CMP   r0, r1
  STRNE r2, [r0], #4 @ store zeros in bss
  BNE   __zero_bss

  @ system-initalization (clocks, interrupts, )
  BL    __sysinit
  BL    _start
  @ go to default handler if we return from main firmware loop
  B     default_handler
